      ...
      <div className="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
        ...
        <div className="mt-12">
            ...
            <div>
              ...
              <input className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" required type="text" placeholder="mike@gmail.com" />
            </div>
            <div className="mt-8">
              ...
              <input className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" required type="password" placeholder="Enter your password" />
            </div>
            <div className="mt-10">
              ...
              <button
                ...
                className="  text-black p-4 w-full rounded-full tracking-wide
                          font-semibold font-display focus:outline-none focus:shadow-outline hover:bg-indigo-600
                          shadow-lg my-2"
                    >
                      Login with Google
          ...
          <div className="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                Don't have an account ?  <Link className={styles.link} href="/dashboard/register">
                         Create new account
                      </Link>
          </div>
        </div>
            ...
            <Image
              src='https://i.ibb.co/VYY5b0J/signin.png'
              alt="Logo"
              width={500}
              height={500}
              style={{width:'800px'}}
